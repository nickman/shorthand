 ...
 * <p>Description: A simple text (non-JSON) syntax for shorthand scripts. We should really write a proper parser for this.</p> 
...
public class ShorthandSimpleScript  {
	...
	/**
	 * Returns a parsed ShorthandSimpleScript instance for the passed source
	 * @param source The source to parse
	 * @return a parsed ShorthandSimpleScript instance 
	 */
	public static ShorthandSimpleScript parse(CharSequence source) {
		...
		return new ShorthandSimpleScript(source.toString().trim());
	}
	 ...
	 * @param source The source to parse
	 */
	private ShorthandSimpleScript(String source) {
		this(source, null);
	}
	 ...
	 */
	private ShorthandSimpleScript(String source, Object classLoader) {
